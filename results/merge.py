...
def main():
    ...
    categories = {
        "agv_performance_bm_*.csv": "agv_performance.csv",
        "results_bm_*.csv": "results.csv",
        "segment_congestion_bm_*.csv": "segment_congestion.csv",
        "machine_utilization_bm_*.csv": "machine_utilization.csv",
    }
